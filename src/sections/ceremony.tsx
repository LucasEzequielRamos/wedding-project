  ...
  return (
    ...
    >
      ...
      <div className="flex  w-auto justify-between gap-4">
        <picture className="relative max-w-[155px] h-[232px] md:max-w-[300px] md:h-auto">
          <img
          ...
          <img
            ...
            alt="image_ceremony"
            className="max-w-[155px] md:max-w-[300px] h-auto"
          />
          <img
            src="/icons/mark_images.svg"
            alt="marco para la imagen"
        ...
        <div className=" flex flex-col ">
          ...
          <p className="md:text-lg text-[8px] flex h-full items-end pb-2">
